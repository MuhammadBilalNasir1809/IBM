        ...
        <div className="developer-section">
            ...
            <div className="developer-columns">
                <div className="column">
                    ...
                    <ul>
                        <li><a href="https://www.ibm.com">Start building with IBM Granite® models <span aria-hidden="true">→</span></a></li>
                        <li><a href="https://www.ibm.com">Explore AI courses, APIs, data sets and more <span aria-hidden="true">→</span></a></li>
                        <li><a href="https://www.ibm.com">Power your future, build your dev skills <span aria-hidden="true">↗</span></a></li>
                        <li><a href="https://www.ibm.com">Monitor agentic AI performance with watsonx.governance <span aria-hidden="true">→</span></a></li>
                    </ul>
                ...
                <div className="column">
                    ...
                    <ul>
                        <li><a href="https://www.ibm.com">Read why Gartner named IBM a Leader in Data Science and ML <span aria-hidden="true">→</span></a></li>
                        <li><a href="https://www.ibm.com">Discover why Omdia ranked IBM a Leader in IDE Assistants <span aria-hidden="true">→</span></a></li>
                        <li><a href="https://www.ibm.com">Get 25% off watsonx Code Assistant™ Essentials <span aria-hidden="true">→</span></a></li>
                        <li><a href="https://www.ibm.com">See why Granite Vision tops the SLMs chart in doc understanding <span aria-hidden="true">→</span></a></li>
                    </ul>
